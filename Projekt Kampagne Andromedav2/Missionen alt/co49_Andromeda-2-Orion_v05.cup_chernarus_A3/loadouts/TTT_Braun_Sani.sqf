...
_unit addItemToVest "ace_marker_flags_green";
_unit addItemToVest "ace_marker_flags_yellow";
_unit addItemToVest "ace_marker_flags_red";
_unit addItemToVest "G_Respirator_yellow_F";
...
for "_i" from 1 to 9 do {_unit addItemToBackpack "ACE_surgicalKit";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "mts_items_flag_blue";};

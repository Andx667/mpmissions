...
for "_i" from 1 to 2 do {_unit addItemToBackpack "ace_marker_flags_black";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "ace_marker_flags_red";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "ace_marker_flags_purple";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "ace_marker_flags_orange";};

...
ASL_SET_MASS = [5000];                                                      // Alles was schwerer ist wird so schwer bzgl Slingload (5440 max für Merlin)
ASL_SUPPORTED_VEHICLES_OVERRIDE = ["UK3CB_BAF_Merlin_HC3_18_GPMG_DPMW"];    // Nur der Merlin kann Advanced Slingloaden
...
// CDF Log Fhz
[
    [log_01, log_02, log_03, log_04, gaz_01, gaz_02],
    [
        ["B_AssaultPack_blk", 1]
    ]
] call reim_fnc_crateFiller;

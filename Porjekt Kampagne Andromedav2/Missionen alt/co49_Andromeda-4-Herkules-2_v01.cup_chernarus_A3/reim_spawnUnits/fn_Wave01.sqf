...
missionNamespace setVariable ["reimVar_startWave1",true,true];
varCounterWave_1 = 0;

while {true} do {
	if (!isNil "reimVar_stopWave1") exitWith {};
	varCounterWave_1 = varCounterWave_1 + 1;
				...
				"UK3CB_KDF_O_MTLB_PKT"
					...
					[	
						...
						[
							...
							[(getMarkerPos "wp_10"),2,"RED","NORMAL","MOVE","SAFE",["true",""]],
							[(getMarkerPos "wp_11"),3,"RED","NORMAL","MOVE","AWARE",["true",""]],
							[(getMarkerPos "wp_12"),4,"RED","NORMAL","MOVE","AWARE",["true",""]],
							[(getMarkerPos "wp_15"),5,"RED","NORMAL","SAD","COMBAT",["true",""]]
						],
						false,
						true,
						"UK3CB_KDF_O_MTLB_PKT"

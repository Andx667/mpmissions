...
force force kat_circulation_AED_X_Monitor_SpO2Warning = 85; //adjust for TTT
...
force forcekat_ophthalmology_eyeshield_medic_required = 0;
force forcekat_ophthalmology_eyeshield_treatment_time = 2;
force forcekat_ophthalmology_eyewash_medic_required = 0;
force forcekat_ophthalmology_eyewash_treatment_time = 2;
force forcekat_ophthalmology_probability_dust = 5;
force forcekat_ophthalmology_probability_dust_heavy = 1;
force forcekat_ophthalmology_probability_treatment_dust = 20;
...
force force kat_pharma_carbonateChance = 0;
...
force force kat_pharma_coagulation_allow_MediumWounds = false;
...
force force kat_pharma_medLvl_Etomidate = 2; //not used
force force kat_pharma_medLvl_Fentanyl = 2;
force force kat_pharma_medLvl_Flumezenil = 2; //not used
...
force force kat_pharma_medLvl_Nitroglycerin = 2; //not used
force force kat_pharma_medLvl_Norepinephrine = 2; //not used
force force kat_pharma_medLvl_Penthrox = 0;
force force kat_pharma_medLvl_Pervitin = 0; //not used
force force kat_pharma_medLvl_Phenylephrine = 0; //not used
...
force force kat_watch_pressureUnit = 1;

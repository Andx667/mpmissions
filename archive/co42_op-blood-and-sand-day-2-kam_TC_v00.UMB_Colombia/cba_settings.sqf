...
force ace_medical_stateMachine_cardiacArrestTime = 1800; //20 Minuten Lifetime

force ace_medical_treatment_locationSurgicalKit = 3;   //überall - Aternativ 3
...
force kat_airway_medLvl_Accuvac = 1; //Medic
...
force kat_breathing_medLvl_PocketBVM = 1; //Medics
force kat_breathing_medLvl_Pulseoximeter = 0; //anyone
...
force kat_breathing_severeValue = 66; //kurz vor Tod
...
force kat_chemical_gasMaskSoundVolume = 1;
...
//KAM MISC
force kat_misc_AFAK_Container = 0;
force kat_misc_AFAK_RemoveWhenEmpty = true;
force kat_misc_AFAKFifthSlotItem = "[]";
force kat_misc_AFAKFirstSlotItem = "[]";
force kat_misc_AFAKFourthSlotItem = "[]";
force kat_misc_AFAKSecondSlotItem = "[]";
force kat_misc_AFAKSixthSlotItem = "[]";
force kat_misc_AFAKThirdSlotItem = "[]";
force kat_misc_allowSharedVehicleEquipment = 4;
force kat_misc_armbandSlingLeftArm = "[0.2, -0.39, -0.2]";
force kat_misc_armbandSlingLeftArmRotation = "[240, 33, 26]";
force kat_misc_armbandSlingLeftLeg = "[0.435, -0.075, -0.38]";
force kat_misc_armbandSlingLeftLegRotation = "[-160, -5, 45]";
force kat_misc_armbandSlingRightArm = "[-0.228, -0.1, -0.43]";
force kat_misc_armbandSlingRightArmRotation = "[5, -5, -5]";
force kat_misc_armbandSlingRightLeg = "[-0.32, -0.29, -0.42]";
force kat_misc_armbandSlingRightLegRotation = "[-30, -5, 38]";
force kat_misc_enable = true;
force kat_misc_enableStitchFullBody = false;
force kat_misc_IFAK_Container = 0;
force kat_misc_IFAK_RemoveWhenEmpty = true;
force kat_misc_IFAKFirstSlotItem = "[]";
force kat_misc_IFAKFourthSlotItem = "[]";
force kat_misc_IFAKSecondSlotItem = "[]";
force kat_misc_IFAKThirdSlotItem = "[]";
force kat_misc_IFAKThirdSlotItem = "[]";
force kat_misc_incompatibilityWarning = true;
force kat_misc_MFAK_Container = 0;
force kat_misc_MFAK_RemoveWhenEmpty = true;
force kat_misc_MFAKEighthSlotItem = "[]";
force kat_misc_MFAKFifthSlotItem = "[]";
force kat_misc_MFAKFirstSlotItem = "[]";
force kat_misc_MFAKFourthSlotItem = "[]";
force kat_misc_MFAKSecondSlotItem = "[]";
force kat_misc_MFAKSeventhSlotItem = "[]";
force kat_misc_MFAKSixthSlotItem = "[]";
...
//KAM Pharmacy
force kat_pharma_allowStackScript_EACA = true; //ToDo
force kat_pharma_allowStackScript_TXA = true; //ToDo
...
force kat_pharma_CheckCoag_Location = 0; //everywhere
force kat_pharma_CheckCoag_MedLevel = 1; // Medic
...
force kat_pharma_medLvl_Amiodarone = 2; //Doctor
force kat_pharma_medLvl_ApplyIO = 1; //Medic
force kat_pharma_medLvl_ApplyIV = 1; //Medic
force kat_pharma_medLvl_Atropine = 2; //Doctor
force kat_pharma_medLvl_Caffeine = 0;
force kat_pharma_medLvl_Carbonate = 2; //Doctor
...
force kat_pharma_medLvl_Lidocaine = 1;  //Medic
force kat_pharma_medLvl_Lorazepam = 2;
force kat_pharma_medLvl_Nalbuphine = 1;  //Medic
force kat_pharma_medLvl_Naloxone = 1;  //Medic
force kat_pharma_medLvl_Nitroglycerin = 2;
force kat_pharma_medLvl_Norepinephrine = 2;
force kat_pharma_medLvl_Penthrox = 1;  //Medic
force kat_pharma_medLvl_Pervitin = 0;
force kat_pharma_medLvl_Phenylephrine = 2;
force kat_pharma_medLvl_Reorientation = 0;  //anyone
...
force kat_surgery_fractureCheck_MedLevel = 2;
...
force kat_surgery_pericardialtapLocation = 4;

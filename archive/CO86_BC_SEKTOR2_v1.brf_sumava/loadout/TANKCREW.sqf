...
for "_i" from 1 to 8 do {player addItemToUniform "ACE_elasticBandage";};
...
for "_i" from 1 to 5 do {player addItemToVest "BWA3_30Rnd_556x45_G36_AP";};
...
[player,"AfricanHead_01","male05eng"] call BIS_fnc_setIdentity;

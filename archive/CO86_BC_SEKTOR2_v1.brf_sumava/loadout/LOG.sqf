...
player addVest "CUP_V_B_GER_PVest_Fleck_RFL_LT";
...
for "_i" from 1 to 7 do {player addItemToVest "BWA3_30Rnd_556x45_G36_AP";};
...
[player,"WhiteHead_09","male09eng"] call BIS_fnc_setIdentity;

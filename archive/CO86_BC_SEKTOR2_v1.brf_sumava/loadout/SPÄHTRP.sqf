...
for "_i" from 1 to 4 do {player addItemToVest "BWA3_20Rnd_762x51_G28_SD";};
player addItemToBackpack "ACRE_PRC117F";
player addItemToBackpack "ItemcTabMisc";
for "_i" from 1 to 6 do {player addItemToBackpack "BWA3_20Rnd_762x51_G28_LR";};
for "_i" from 1 to 4 do {player addItemToBackpack "BWA3_20Rnd_762x51_G28_SD";};
for "_i" from 1 to 2 do {player addItemToBackpack "BWA3_20Rnd_762x51_G28_Tracer";};
...
[player,"WhiteHead_21","male03eng"] call BIS_fnc_setIdentity;

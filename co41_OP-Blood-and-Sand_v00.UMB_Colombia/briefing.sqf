...
player createDiaryRecord ["Diary", [
    "02 Auftrag",
    "USMC Platoon"
    + "- landet bei <marker name='marker_3'>San Antonio</marker>,<br/>"
    + "- nimmt Feind Kaserne bei San Antonio <marker name='marker_2'>Obj. 1</marker>,<br/>"
    + "- nimmt <marker name='marker_1'>Obj. 2</marker>,<br/>"
    + "und richtet sich ein zur zeitlich begrenzten Verteidigung,<br/>"
...
player createDiaryRecord ["Diary", [
    ...
    + "<t/> - In Obj. 21 feindliche Infanterie in Zugstärke, teils gehärtete Stellungen, vermutete Absicht ist es die Stellung zu halten und uns ein weiteres Vorstoßen nicht zu ermöglichen,<br/>"

...
comment "Add weapons";
player addWeapon "CUP_lmg_m249_pip2";
player addPrimaryWeaponItem "CUP_optic_Elcan_SpecterDR_black";
player addPrimaryWeaponItem "CUP_200Rnd_TE1_Red_Tracer_556x45_M249_Pouch";
...
for "_i" from 1 to 4 do {player addItemToVest "CUP_200Rnd_TE1_Red_Tracer_556x45_M249_Pouch";};

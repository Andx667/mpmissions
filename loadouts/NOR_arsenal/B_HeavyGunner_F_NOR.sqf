...
comment "Add weapons";
player addWeapon "CUP_lmg_FNMAG_RIS_modern";
...
player addVest "CFP_FAPC_MG_OGA";
...
for "_i" from 1 to 5 do {player addItemToVest "CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M";};

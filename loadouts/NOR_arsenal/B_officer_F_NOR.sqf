...
player addPrimaryWeaponItem "CUP_optic_AIMM_COMPM4_BLK";
player addPrimaryWeaponItem "CUP_30Rnd_556x45_PMAG_BLACK_Tracer_Red";
...
for "_i" from 1 to 8 do {player addItemToVest "CUP_30Rnd_556x45_PMAG_BLACK_Tracer_Red";};

...
player forceAddUniform "CUP_U_B_BAF_MTP_UBACSSEAL";
...
for "_i" from 1 to 19 do {player addItemToBackpack "ACE_elasticBandage";};
for "_i" from 1 to 19 do {player addItemToBackpack "ACE_packingBandage";};

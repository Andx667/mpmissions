...
player addBackpack "CUP_B_Predator_MTP";
...
for "_i" from 1 to 80 do {player addItemToBackpack "ACE_packingBandage";};
for "_i" from 1 to 80 do {player addItemToBackpack "ACE_quikclot";};
for "_i" from 1 to 80 do {player addItemToBackpack "ACE_elasticBandage";};
for "_i" from 1 to 32 do {player addItemToBackpack "ACE_Tourniquet";};
for "_i" from 1 to 16 do {player addItemToBackpack "kat_larynx";};
for "_i" from 1 to 6 do {player addItemToBackpack "kat_pocketBVM";};
for "_i" from 1 to 16 do {player addItemToBackpack "kat_ncdKit";};
for "_i" from 1 to 16 do {player addItemToBackpack "kat_chestSeal";};
for "_i" from 1 to 32 do {player addItemToBackpack "kat_IV_16";};
...
for "_i" from 1 to 16 do {player addItemToBackpack "ACE_adenosine";};
for "_i" from 1 to 16 do {player addItemToBackpack "ACE_morphine";};
for "_i" from 1 to 16 do {player addItemToBackpack "kat_Penthrox";};
for "_i" from 1 to 16 do {player addItemToBackpack "kat_Painkiller";};
for "_i" from 1 to 16 do {player addItemToBackpack "kat_naloxone";};
for "_i" from 1 to 80 do {player addItemToBackpack "ACE_Suture";};

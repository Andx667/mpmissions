...
player addItemToVest "iedd_item_notebook";
player addItemToVest "ACRE_PRC152";
for "_i" from 1 to 3 do {player addItemToBackpack "DemoCharge_Remote_Mag";};
for "_i" from 1 to 20 do {player addItemToBackpack "ace_marker_flags_orange";};
for "_i" from 1 to 10 do {player addItemToBackpack "mts_items_marker_mines";};
for "_i" from 1 to 10 do {player addItemToBackpack "mts_items_marker_yellow";};

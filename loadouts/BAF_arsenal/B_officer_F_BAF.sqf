...
player addPrimaryWeaponItem "CUP_30Rnd_556x45_Stanag_L85_Tracer_Red";
...
player addVest "CUP_V_B_BAF_MTP_Osprey_Mk4_Officer";
player addBackpack "CUP_B_Motherlode_Radio_MTP";
...
for "_i" from 1 to 8 do {player addItemToVest "CUP_30Rnd_556x45_Stanag_L85_Tracer_Red";};
...
for "_i" from 1 to 10 do {player addItemToBackpack "CUP_1Rnd_SmokeRed_M203";};
player addItemToBackpack "TTT_Spraypaint2";

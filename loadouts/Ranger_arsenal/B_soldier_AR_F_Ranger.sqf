...
comment "Add weapons";
player addWeapon "CUP_lmg_m249_pip4";
player addPrimaryWeaponItem "CUP_acc_ANPEQ_15_Flashlight_Black_L";
player addPrimaryWeaponItem "CUP_optic_Elcan_SpecterDR_black";
...
player addVest "CFP_LBT6094_MG_Multicam";
...
for "_i" from 1 to 4 do {player addItemToVest "CUP_100Rnd_TE4_Red_Tracer_556x45_M249";};
for "_i" from 1 to 3 do {player addItemToBackpack "CUP_100Rnd_TE4_Red_Tracer_556x45_M249";};

...
player addPrimaryWeaponItem "CUP_30Rnd_556x45_Emag_Tracer_Red";
...
player addVest "CUP_V_PMC_CIRAS_OD_TL";
...
for "_i" from 1 to 8 do {player addItemToVest "CUP_30Rnd_556x45_Emag_Tracer_Red";};

...
for "_i" from 1 to 8 do {player addItemToUniform "kat_Painkiller";};
...
player addItemToBackpack "ttt_flags_blau";
...
player addGoggles "USP_DETCORD_BLK2";
...
[player,"Barklem","male09eng"] call BIS_fnc_setIdentity;

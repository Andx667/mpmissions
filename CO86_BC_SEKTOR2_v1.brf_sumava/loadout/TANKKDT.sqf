...
for "_i" from 1 to 6 do {player addItemToBackpack "BWA3_30Rnd_556x45_G36_AP";};
for "_i" from 1 to 6 do {player addItemToBackpack "BWA3_30Rnd_556x45_G36_Tracer";};
...
[player,"WhiteHead_11","male12eng"] call BIS_fnc_setIdentity;
